      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-playfair font-bold text-white">Lens<span className="text-amber-500">&</span>Light</span>
            </div>
        ...
        <div className="pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-500 text-sm">
            © {currentYear} Lens & Light Photography. All rights reserved. Made with <Heart className="w-4 h-4 inline text-red-500" /> in India.
          </p>
        </div>
      </div>
    </footer>
